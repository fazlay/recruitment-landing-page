...
export default () => {
  ...
  const cards = [
    ...
    { imageSrc: SupportIconImage, title: "Primary Screening" },
    { imageSrc: CustomizeIconImage, title: "Talent Hunt" },
    { imageSrc: ReliableIconImage, title: "Company Outreach" },
    { imageSrc: FastIconImage, title: "PR Campaign" },
    { imageSrc: SimpleIconImage, title: "Overseas Recruitment" }
  ];
